...
export class Calc2 extends React.Component {
              ...
              <form>
                ...
                <div className="form-group">
                  ...
                  <div className="row">
                    ...
                    <div className="col-xs-6">
                      <input className="form-control" id="bmiHeightInch" type="number" min="0" max="11" value={ this.state.heightInch } onChange={ this.handleHeightInchChange } />
